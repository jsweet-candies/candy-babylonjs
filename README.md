# JSweet babylonjs candy

## Description

This project is a Java bridge to the babylonjs library, so that babylonjs can be used from Java (thanks to the JSweet transpiler).
...
<dependency>
	...
	<artifactId>babylonjs</artifactId>
